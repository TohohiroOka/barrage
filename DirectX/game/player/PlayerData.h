...
enum PlayerAnimationName
{
	...
	ROLL_ANIMATION,//8
	RUN_ANIMATION,//9
	HEAVY_ATTACK1_ANIMATION,//10
	HEAVY_ATTACK2_ANIMATION,//11
	HEAVY_ATTACK3_ANIMATION,//12
	NO_DATA_1,//13
	HEAVY_ATTACK1_ANIMATION_1,//14
	HEAVY_ATTACK2_ANIMATION_2,//15
	HEAVY_ATTACK3_ANIMATION_3,//16
